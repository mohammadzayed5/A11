...
public:
    ...
    virtual void inserthead( Type *newItem) = 0;
    ...
    virtual void inserttail( Type *newItem) = 0;
...
void linkedListType<Type>::destroyList()
{
    ...
    {                          //the list
        ...
        head = head->next; //advance head to the link node
        delete temp->data; //delete the data
                   ...
                   (const linkedListType<Type>& otherList) 
{
    ...
    else
    {
        ...
        current = current->next;     //make current point to
                                     //the link node
		cout << "copy the remaining list" << endl;
